		...
		<div class="div_total">
			...
			<div style="margin-top: 30px;float: left;margin-left: 110px;">
				<div style="float: left;">
					<label>创建人：</label>
					<div class = "layui-input-inline">
						<select name = "establish" class = "layui-select establish">
			...
			<div style="margin-top: 30px;float: left;margin-left: 62px;">
				<label class = "layui-form-label" style = "margin-top:52px;">执行备注：</label>
				<textarea style="width: 508px;height: 100px;margin-top: 20px;" name = "performance" class = "performance"></textarea>
			</div>
			<div style="float: left;margin-top: 39px;width:200px ;height: 100px;margin-left: 325px;">
				<input type="button" value="执行"  id = "Ability" class = "layui-btn"/>
		...
		<script type = "text/javascript">
			...
			function force(){
				$("#Ability").on("click",function(){
					$.ajax({
						url:'../../../executiveAction?con.contractId='+$(".contractId").val(),
						data:$("#huy").serialize(),
						type:'post',
						success:function(data){
							var index = parent.layer.getFrameIndex(window.name); //获取窗口索引
							parent.layer.msg("合同执行成功！");
