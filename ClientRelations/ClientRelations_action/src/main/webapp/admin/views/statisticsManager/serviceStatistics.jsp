...
<body class="layui-view-body">
	<div class="layui-content">
		<div class="layui-page-header">
			<div class="pagewrap">
				<span class="layui-breadcrumb"> <a href="">统计分析</a><a><cite>客户服务统计</cite></a>
				</span>
				<h2 class="title">客户服务统计</h2>
			</div>
		</div>
		<div class="layui-row">
					...
					<div class="form-box">
						<div class="layui-form layui-form-item">
							<div class="layui-inline">
								...
								<div class="layui-input-inline" style="width: 150px;">
									<input type="dateTime" name="end_time" class="layui-input" id="end_time" placeholder="开始时间">
								</div>
